...
if __name__ == '__main__':
    ...
    parser.add_argument('--adult_filter_off', action='store_true', help='Whether to turn off the adult filter.')
    parser.add_argument('--force_replace', action='store_true', help='Whether to replace existing files.')
